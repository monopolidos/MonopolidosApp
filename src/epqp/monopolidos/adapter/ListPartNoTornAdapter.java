...
public class ListPartNoTornAdapter extends BaseAdapter {
	...
	public ListPartNoTornAdapter(Activity context, ArrayList<Partida> p, int width, int height){
		partides = p;
	...
	public View getView(int pos, View convertView, ViewGroup viewGroup) {
		...
		noConfirm.setText("Turn of: " + p.getPlayerTornName());
