...
public class ListPartEsperaAdapter extends BaseAdapter {
	...
	public ListPartEsperaAdapter(Activity context, ArrayList<Partida> p, int width, int height){
		partides = p;
	...
	public View getView(int pos, View convertView, ViewGroup viewGroup) {
		...
		params.leftMargin = (int) (width * 0.1);
		noConfirm.setLayoutParams(params);
		scaledPx = (float) (height * 0.25 * 0.5  / densityMultiplier);
		noConfirm.setTextSize(scaledPx);
		noConfirm.setText("No confirmed: " + p.getpPlayersNotConfirmedToString());
		noConfirm.setTextColor(Color.GRAY);
		noConfirm.setEllipsize(TruncateAt.END);
		noConfirm.setSingleLine(true);
