...
public class ListPartidesTornItemClickListener implements OnItemClickListener {

	private PartidesActivity context;
	private ListAdapter adapter;
	
	public ListPartidesTornItemClickListener(PartidesActivity cont, ListAdapter adapter){
		context = cont;
	...
	public void onItemClick(AdapterView<?> adap, View view, int pos, long partidaPK) {
		...
		Log.d("MONOPOLIDOS", "Partida torn -> " + p.getPartidaPK());
